...
scrollDownButton.addEventListener('click', () => {
    ...
    const duration = 1000; // 1 second animation duration (adjust as needed)
    ...
    function step(timestamp) {
        ...
        const easingFunction = t => t * t; // Quadratic ease-in (adjust as needed)
        window.scrollTo(0, startPosition + distance * easingFunction(progress / duration));
...
const scrollDownButtonBreakingNews = document.getElementById('scrollDownButtonBreakingNews');
const targetImage2 = document.getElementById('target2');


scrollDownButtonBreakingNews.addEventListener('click', () => {
    const targetPosition = targetImage2.getBoundingClientRect().top + window.scrollY;
    const startPosition = window.scrollY;
    const distance = targetPosition - startPosition;
    const duration = 1000; // 1 second animation duration (adjust as needed)
    let startTimestamp = null;
